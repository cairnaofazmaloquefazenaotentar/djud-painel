...
/**
 * GET /api/sismat/saidas/sub-materials?materialNome=ABEMACICLIBE
 * Retorna a lista distinta de valores da coluna `material` (nome específico)
 * para o princípio ativo (materialNome) informado.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("[sismat/saidas/sub-materials] Erro:", error);
